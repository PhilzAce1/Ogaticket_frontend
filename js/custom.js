$(document).ready(function () {
  ...
  $('#gallery_img_upload').change(function (event) {
    ...
    $(event.target.files).each(function (index) {
      ...
      imageHTML +=
        '<div class="image-box no-hover position-relative"><img src="' +
        tmppath +
        '" alt="img"><span class="badge badge-primary ml-auto mt-3 pointer border-0 font-weight-normal remove-image position-absolute" data-targetimg="' +
        index +
...
//     var lsitingLocations = [['Maroubra Beach', -33.9169667, 151.2345321, 1]];
...
//         lsitingLocations[i][1],
//         lsitingLocations[i][2]
//       ),
//       map: map,
